<?php
	...
	if (strlen(trim($id_barang))==0) {
		echo "ID Barang Harus Diisi!<br/>";
		$dataValid="TIDAK";
	}
	...
	$sql="insert into barang (id_barang, nama_barang, stok, harga, image)
			values
			('$id_barang','$nama_barang','$stok','$harga','$image')";
	...
	if ($size>0) {
		if (!move_uploaded_file($tmpName, $fileTujuanFoto)) {
			...
			echo "<a href='log-in/index.php'>Daftar Item In-Game DotA 2</a>";
			exit;
		} else {
...
<hr/>
<a href="barang_tampil.php">DAFTAR ITEM In-Game DotA 2</a>